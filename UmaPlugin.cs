...
[Tool]
public partial class UmaPlugin : EditorPlugin
{
    ...
    public override void _EnterTree()
    {
        ...
        editDock.FindNode("save_pose").Connect("pressed", new Callable(this, "openPoseSaveFile"));
        (editDock.FindNode("save_pose_dialog") as FileDialog).Connect("file_selected", new Callable(this, "savePose"));

        editDock.FindNode("save_reciepe").Connect("pressed", new Callable(this, "openReciepeSaveFile"));
        (editDock.FindNode("save_reciepe_dialog") as FileDialog).Connect("file_selected", new Callable(this, "saveReciepe"));

        editDock.FindNode("load_reciepe").Connect("pressed", new Callable(this, "openReciepeFile"));
        (editDock.FindNode("load_reciepe_dialog") as FileDialog).Connect("file_selected", new Callable(this, "loadReciepe"));

        AddControlToContainer(CustomControlContainer.SpatialEditorSideLeft, editDock);
        editDock.Visible = false;

        AddCustomType("UMADnaHumanoid", "Resource", GD.Load<Script>("res://addons/uma/utils/UMADnaHumanoid.cs"), GD.Load<Texture2D>("res://addons/uma/icons/dna.png"));

        AddCustomType("UMASlotOverlayResource", "Resource", GD.Load<Script>("res://addons/uma/utils/UMASlotOverlayResource.cs"), GD.Load<Texture2D>("res://addons/uma/icons/slot.png"));
        AddCustomType("UMAOverlayResource", "Resource", GD.Load<Script>("res://addons/uma/utils/UMAOverlayResource.cs"), GD.Load<Texture2D>("res://addons/uma/icons/overlay.png"));
        AddCustomType("UMASkeleton", "Skeleton", GD.Load<Script>("res://addons/uma/utils/UMASkeleton.cs"), GD.Load<Texture2D>("res://addons/uma/icons/skeleton.png"));

        AddCustomType("UMAOverlay", "MeshInstance3D", GD.Load<Script>("res://addons/uma/utils/UMAOverlay.cs"), GD.Load<Texture2D>("res://addons/uma/icons/overlay.png"));
